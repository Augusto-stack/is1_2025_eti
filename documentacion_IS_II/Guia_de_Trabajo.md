...
- ***Alumnos*** : Las funcionalidades que van a tener son las de inscribirse a las materias, ver sus notas, materias disponibles y profesor asignado.

- ***Profesores*** : Sus funcionalidades serian ver las materias que va a dictar, listado de estudiantes inscriptos en cada una (si tiene mas de una materia asignada), cargar notas y permitir modificaciones a las mismas.

- ***Administrador*** : El admin puede cargar, editar, eliminar cuentas tanto de los profesores, estudiantes, materias, asignar un *profesores* a una materia, reseteo de contraseñas.
...
### d) Tamaño del equipo y Plazo estimado
 ...
 El tamaño de nuestro equipo va a ser de 5 personas y el plazo que creemos que nos va a llevar van a ser 2 meses (tiempo del cursado).

 ### e) Cambio de alcanze ocurridos
